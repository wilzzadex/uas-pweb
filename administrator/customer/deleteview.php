...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="customer/delete.php" name="modal-popup" enctype="multipart/form-data" method="POST">
                <div class="alert alert-danger">Apakah anda yakin ingin menghapus data ini ?</div>
                    <div class="form-group">
                        <label control-label">Kode</label>
                            ...
                            <input type="hidden" name="foto" value="<?php echo $row['photo']; ?>">
                            <input type="hidden" name="kk" value="<?php echo $row['kk']; ?>">
