<?php
    ...
    $id = $_GET['id'];
    $sql = mysqli_query($conn, "select * from damages where id='$id'");
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="kerusakan/delete.php" name="modal-popup" enctype="multipart/form-data" method="POST">
