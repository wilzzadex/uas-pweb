...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" action="pengembalian/edit_proses.php" name="modal-popup" enctype="multipart/form-data" method="POST" id="form-edit">
             <div class="form-group">
              ...
              <div class="">
                ...
                <select class="form-control" name="status">
                  ...
                  <option  value="BARANG SUDAH DI KEMBALIKAN">BARANG SUDAH DI KEMBALIKAN</option>
