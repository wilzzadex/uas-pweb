            ...
            <div class="row gx-5 align-items-center">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../add/simpanedit.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            <label for="name" class="form-label">Nama Resep</label>
                                            <input type="hidden" name="id" value="<?= $data['id'] ?>">
                                            <input type="text" value="<?= $data['title'] ?>" class="form-control" required id="name" name="name" placeholder="Masukkan Nama Resep">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" required name="description" id="description" rows="3" minlength="10" placeholder="Masukkan Deskripsi Resep"><?= $data['description'] ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" required name="status">
                                                ...
                                                <option value="0" <?= $data['status'] == 'draft' ? 'selected' : '' ?>>Draft</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="image" name="image" placeholder="Masukkan Nama Resep" onchange="previewImage(event)" accept=".png, .jpg, .jpeg">
                                        </div>
                                        <div class="mb-3">
                                            <img id="imagePreview" src="
                                            <?= base_url() ?>uploads/<?= $data['image'] ?>" alt="Image Preview" style="width: 100%; height: auto;">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="row" id="bahan">
                                                <?php foreach (get_bahan($data['id']) as $key => $bahan): ?>
                                                    <?php if ($key == 0): ?>
                                                        <div class="col-md-10">

                                                            <input type="text" class="form-control" required name="nama_bahan[]" value="<?= $bahan['item'] ?>" placeholder="Masukkan Nama Bahan">
                                                        </div>
                                                        <div class="col-md-2">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="col-md-10 mt-2">
                                                            <input type="text" class="form-control" required name="nama_bahan[]" value="<?= $bahan['item'] ?>">
                                                        </div>
                                                        <div class="col-md-2 mt-2">
                                                            <button class="btn btn-danger btnDeleteIngredients" type="button">-</button>
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endforeach; ?>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="row" id="petunjuk">
                                                <?php foreach (get_direction($data['id']) as $key => $dir): ?>
                                                    <?php if ($key == 0): ?>
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" required name="petunjuk[]" placeholder="Masukkan Petunjuk Pembuatan" value="<?= $dir['step'] ?>">
                                                        </div>
                                                        <div class="col-md-2">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="col-md-10 mt-2">
                                                            <input type="text" class="form-control" required name="nama_bahan[]" value="<?= $dir['step'] ?>">
                                                        </div>
                                                        <div class="col-md-2 mt-2">
                                                            <button class="btn btn-danger btnDeleteIngredients" type="button">-</button>
                                                        </div>
