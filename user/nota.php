...
?>
    ...
    <h3 class="panel-title"><strong>Pemberitahuan</strong></h3>
    <label >- Pembayaran Pertama Harus Langsung Lunas </label> <br>
    <label id="ket1" >- Pembayaran Melalui TRANSFER BANK BCA No REK : 2780213682 </label> <br>
    <label id="ket2" >- Atas Nama : SURANTI </label>
</div>
